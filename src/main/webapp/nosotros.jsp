		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-3 pb-5">
				<div class="h-100 py-5 services-icon-wap shadow">
					...
					<h2 class="h5 mt-4 text-center">Entregas a  Domicilio</h2>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-3 pb-5">
				<div class="h-100 py-5 services-icon-wap shadow">
					...
					<h2 class="h5 mt-4 text-center">Envios & Devoluciones</h2>
				</div>
			</div>
		...
		<div class="container my-4">
			<div class="row text-center py-3">
				<div class="col-lg-6 m-auto">
					...
					<p>Contamos con las mejores marcas reconocidas a nivel
						internacional</p>
				</div>
								...
								<div class="carousel-inner product-links-wap" role="listbox">
									...
									<div class="carousel-item active">
										<div class="row">
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 70px; margin-top: 20px"
											...
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top: 17px"
													class="img-fluid brand-img" src="assets/img/brand_03.png"
													alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top: 25px"
										...
										<div class="row">
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 70px"
													class="img-fluid brand-img" src="assets/img/brand_05.png"
													alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
											...
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top: 18px"
													class="img-fluid brand-img" src="assets/img/brand_07.png"
													alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-bottom: 28px"
													class="img-fluid brand-img" src="assets/img/brand_08.png"
													alt="Brand Logo"></a>
											</div>
										</div>
									</div>
									...
									<div class="carousel-item">
										<div class="row">
											...
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 70px"
													class="img-fluid brand-img" src="assets/img/brand_10.png"
													alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 150px"
													class="img-fluid brand-img" src="assets/img/brand_11.png"
													alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top: 8px"
													class="img-fluid brand-img" src="assets/img/brand_12.png"
													alt="Brand Logo"></a>
											</div>
										</div>
									</div>

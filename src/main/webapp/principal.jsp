			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						<li class="nav-item"><a class="nav-link" href="nosotros.jsp">Nosostros</a>
						</li>
					</ul>
				</div>
				...
				<ul class="list-unstyled templatemo-accordion">
					<li class="pb-3"><a
						...
						<ul class="collapse show list-unstyled pl-3">
							...
							<li><a class="text-decoration-none" href="#">Femenino</a></li>
						</ul></li>					
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						href="#"> Productos <i
					...
					<div class="col-md-6">
						<ul class="list-inline shop-top-menu pb-3 pt-1">
							<li class="list-inline-item"><a
								class="h3 text-dark text-decoration-none mr-3" href="#">Todo</a>
							</li>							
						</ul>
					</div>					
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="card mb-4 product-wap rounded-0">
							...
							<div class="card-body">
								<a href="detalle.jsp" class="h3 text-decoration-none">LAPTOP ASUS X1605ZA-MB252W</a>
								<ul
									class="w-100 list-unstyled d-flex justify-content-between mb-0">
									<li>16" INTEL CORE I5 8GB RAM 512GB SSD</li>
									<li class="pt-2"><span
		...
		<div class="container my-4">
			<div class="row text-center py-3">
				<div class="col-lg-6 m-auto">
					...
					<p>Contamos con las mejores marcas reconocidas a nivel internacional</p>
				</div>
					...
					<div class="row d-flex flex-row">
						...
						<div class="col-1 align-self-center">
							<a class="h1" href="#multi-item-example" role="button"
								...
								class="text-dark fas fa-chevron-left"></i>
							</a>
						</div>
						<!--End Controls-->
							...
							<div class="carousel slide carousel-multi-item pt-2 pt-md-0"
								...
								<div class="carousel-inner product-links-wap" role="listbox">
									...
									<div class="carousel-item active">
										<div class="row">
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 70px; margin-top: 20px" class="img-fluid brand-img"
													src="assets/img/brand_01.png" alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 180px" class="img-fluid brand-img"
													src="assets/img/brand_02.png" alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top:17px" class="img-fluid brand-img"
													src="assets/img/brand_03.png" alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top:25px" class="img-fluid brand-img"
									...
									<div class="carousel-item">
										<div class="row">
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 70px" class="img-fluid brand-img"
											...
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top:18px" class="img-fluid brand-img"
													src="assets/img/brand_07.png" alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-bottom:28px" class="img-fluid brand-img"
									...
									<div class="carousel-item">
										<div class="row">
											...
											<div class="col-3 p-md-5">
												<a href="#"><img style="width: 150px" class="img-fluid brand-img"
													src="assets/img/brand_11.png" alt="Brand Logo"></a>
											</div>
											<div class="col-3 p-md-5">
												<a href="#"><img style="margin-top:8px" class="img-fluid brand-img"
						...
						<div class="col-1 align-self-center">
							<a class="h1" href="#multi-item-example" role="button"
								...
								class="text-dark fas fa-chevron-right"></i>
							</a>
						</div>
						<!--End Controls-->
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 pt-5">
					<h2 class="h2 text-success border-bottom pb-3 border-light logo">Tech Store</h2>
